...
class MovieResultTest {
    ...
    private val listOfMovies = listOf(
        MovieResult(
            ...
            popularity=7517.432, posterPath="/1g0dhYtq4irTY1GPXvft6k4YLjm.jpg",
        ...
        MovieResult(
            ...
            popularity=3850.439, posterPath="/4j0PNHkMr5ax3IA8tjtxcmPU3QT.jpg",
        ...
        MovieResult(
            ...
            popularity=3507.4, posterPath="/aq4Pwv5Xeuvj6HZKtxyd23e6bE9.jpg",
        ...
        MovieResult(
            ...
            popularity=3560.934, posterPath="/kZNHR1upJKF3eTzdgl5V8s8a4C3.jpg",
        ...
        MovieResult(
            ...
            popularity=2960.414, posterPath="/zzXFM4FKDG7l1ufrAkwQYv2xvnh.jpg",
        ...
        MovieResult(
            ...
            popularity=2728.228, posterPath="/680klE0dIreQQOyWKFgNnCAJtws.jpg",
        ...
        MovieResult(
            ...
            popularity=2785.625, posterPath="/okNgwtxIWzGsNlR3GsOS0i0Qgbn.jpg",
        ...
        MovieResult(
            ...
            popularity=2325.902, posterPath="/teCy1egGQa0y8ULJvlrDHQKnxBL.jpg",
        ...
        MovieResult(
            ...
            popularity=2017.573, posterPath="/4NUzcKtYPKkfTwKsLjwNt8nRIXV.jpg",
        ...
        MovieResult(
            ...
            popularity=2076.654, posterPath="/mtLk7vugGWtMkO913Fg8zfM1YET.jpg"
        ...
        MovieResult(
            ...
            popularity=1956.577, posterPath="/aWeKITRFbbwY8txG5uCj4rMCfSP.jpg",
        ...
        MovieResult(
            ...
            popularity=2099.68, posterPath="/bcCBq9N1EMo3daNIjWJ8kYvrQm6.jpg",
        ...
        MovieResult(
            ...
            popularity=2380.14, posterPath="/meRIRfADEGVo65xgPO6eZvJ0CRG.jpg",
        ...
        MovieResult(
            ...
            popularity=2160.331, posterPath="/i0z8g2VRZP3dhVvvSMilbOZMKqR.jpg",
            releaseDate="2022-01-28",
        ...
        MovieResult(
            ...
            popularity=1623.29, posterPath="/3cccEF9QZgV9bLWyupJO41HSrOV.jpg",
        ...
        MovieResult(
            ...
            popularity=1764.309, posterPath="/wdE6ewaKZHr62bLqCn7A2DiGShm.jpg"
        ...
        MovieResult(
            ...
            popularity=1741.374, posterPath="/ko1JVbGj4bT8IhCWqjBQ6ZtF2t.jpg",
        ...
        MovieResult(
            ...
            popularity=1338.427, posterPath="/tlZpSxYuBRoVJBOpUrPdQe9FmFq.jpg",
            releaseDate="2022-02-10",
        ...
        MovieResult(
            ...
            popularity=1556.443, posterPath="/sg4xJaufDiQl7caFEskBtQXfD4x.jpg",
        ...
        MovieResult(
            ...
            popularity=1367.529, posterPath="/rjkmN1dniUHVYAtwuV3Tji7FsDO.jpg",
            releaseDate="2021-09-30",
            title="Venom: Let There Be Carnage", video=false, voteAverage=7.1, voteCount=6440)
    )

    @Test
    fun isMovieCorrect(movie: MovieResult) {
        val mockedMovie = mockk<MovieResult>()
    }


    @Test
    fun `test If all movies are correct`() {
        listOfMovies.forEach {currentMovie ->
            isMovieCorrect(currentMovie)
        }
    }
