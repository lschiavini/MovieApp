...
//        mockFetchFromRemote()
    ...
    private fun mockFetchFromRemote() {
        ...
        storeMoviesLocally(listOfMovies)
    }
    ...
    private fun fetchFromRemote() {
        runBlocking {
            launch {
                try{
                    val listOfMovies = KTorSimpleClient().getMovies()
    ...
    private fun storeMoviesLocally(list: List<MovieResult>) {
